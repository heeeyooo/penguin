    ...
    <>
      <div id="mobile-menu" className="menu-container">
        ...
        <div className="link-menu-container">
          ...
          <a onClick={closeMenu} className="link2 menu-link2" href="#section2">
            Skills
          </a>
          {/* <NavLink
            onClick={closeMenu}
          ...
          <a onClick={closeMenu} className="link3 menu-link3" href="#section3">
            Projects
          </a>
          {/* <NavLink
            onClick={closeMenu}
          ...
          <a onClick={closeMenu} className="link4 menu-link4" href="#section4">
            Contact me
          </a>
          <div className="resume-container">
            <a className="link5" href={Resume} target="_blank">
              Resume
            </a>
            <a className="link5" href={Resume} target="_blank" download={true}>
