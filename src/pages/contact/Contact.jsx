...
function Contact() {
  ...
  addEventListener("scroll", () => {
    if (
      document.querySelector(".contact-info").getBoundingClientRect().top <
        window.innerHeight &&
      document.querySelector(".contact-info").getBoundingClientRect().bottom > 0
    ) {
      document.querySelector(".contact-info").classList.add("reveal-info");
    }
  });
